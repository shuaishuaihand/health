       ...
       created(){
        ...
        methods: {
          getData(){
            ...
            this.$axios.get(`http://localhost:5050/getUserById/${this.id}`).then(data=>{
              if(data){
                this.user= data.data;
              }
            })
          ...
          updateUser(user) {
                console.log(user.id+"shuaishai");
              /*  this.$axios.put(`http://localhost:5050/editUser`, JSON.stringify(user),{
                    headers: {
            ...
            onSubmit() {
               ...
               /* this.hospital.longitude=this.userlocation.lng;
                ...
                console.log("test111111111");
                       ...
                       this.updateUser(this.user), //将添加的数据提交到后台
